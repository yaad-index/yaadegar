...
export interface components {
    schemas: {
        ...
        ReservationCreated: {
            ...
            /**
             * @description The same instant as confirm_deadline, already written for a person in the instance's configured timezone with that zone named (for example "2026-09-22 20:28 CEST"). Present exactly when confirm_deadline is.
             ...
             */
            confirm_deadline_display?: string;
        };
        MyReservationCreate: {
