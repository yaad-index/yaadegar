...
-- Deliberately mirrors the SQLite schema: portable TEXT/INTEGER types keep the
-- two dialects in lockstep (ADR-0003 §5). The files are kept separate so either
-- can diverge later without touching the other. Every domain table carries
-- tenant_id; every repository query is scoped to it.
